...
import static com.github.robtimus.obfuscation.jackson.Jackson3Obfuscator.DISABLED_STREAM_READ_FEATURES;
import static com.github.robtimus.obfuscation.jackson.Jackson3Obfuscator.ENABLED_JSON_READ_FEATURES;
import static com.github.robtimus.obfuscation.jackson.Jackson3Obfuscator.ENABLED_STREAM_READ_FEATURES;
...
class Jackson3ObfuscatorTest {
    ...
    class Features {
        ...
        private Set<String> readUnsupportedFeatures(String systemPropertyPostfix) {
            String featuresString = System.getProperty("com.github.robtimus.obfuscation.jackson.test.jackson3." + systemPropertyPostfix);
